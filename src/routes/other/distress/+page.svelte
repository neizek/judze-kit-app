<script lang="ts">
	...
	const distressSignals: DistressSignalType[] = [
		...
		},
		{
			...
			label: 'DSC',
			description:
				'A distress alert by means of digital selective calling (DSC) transmitted on: (i) VHF channel 70, or (ii) MF/HF on the frequencies 2187.5 kHz, 8414.5 kHz, 4207.5 kHz, 6312 kHz, 12577 kHz or 16804.5 kHz',
