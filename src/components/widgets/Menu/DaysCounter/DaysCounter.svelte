<script lang="ts">
	import { getDaysBetweenDates } from "$lib/datetime";
...
{#if $daysCounterStore.enabled}
	<div class="equal-flex space" >
		...
		<div class="vertical-flex doubled" style="justify-content: space-around;">
			{#if timePeriod}
				<div class="Motivation absolute-center vertical-flex space-xl max-width centered-content">
					{#if timePeriod ==='before'}
						<span>Embrace the journey ahead — every wave you face will make you stronger.</span>
					{:else}
